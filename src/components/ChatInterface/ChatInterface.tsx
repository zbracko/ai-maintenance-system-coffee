          ...
          <Slider {...mobileButtonSliderSettings}>
            {[
              ...
              <Box key={index} px={1}>
                <Button
                  ...
                  sx={{
                    ...
                    '&::before': {
                      ...
                      width: '100%',
                      height: '100%',
                      background: `linear-gradient(90deg, transparent, ${button.color}20, transparent)`,
                      transition: 'left 0.6s ease',
                    },
                    '&:hover': { 
                      ...
                      transform: 'translateY(-3px) scale(1.02)',
                      boxShadow: `0 15px 40px ${button.color}30`,
                      color: button.color,
                      '&::before': {
                        left: '100%',
                      }
                ...
                >
                  <button.icon sx={{ mr: 2, color: button.color, fontSize: 24 }} />
                  {button.text}
                </Button>
              </Box>
            ))}
            ...
            <Button
              ...
              sx={{ 
                ...
                '&:hover': { 
                  ...
                  boxShadow: `0 20px 50px ${button.color}30`,
                  color: button.color,
                  '&::before': {
                    left: '100%',
                  }
