...
const MAINTENANCE_IMAGES = {
  espresso: '/assets/maintenance/espresso-machine-cleaning.svg',
  cleaning: '/assets/maintenance/espresso-machine-cleaning.svg',
  clean: '/assets/maintenance/espresso-machine-cleaning.svg',
  descaling: '/assets/maintenance/espresso-machine-cleaning.svg',
  grinder: '/assets/maintenance/coffee-grinder-operation.svg',
  grinding: '/assets/maintenance/coffee-grinder-operation.svg',
  grind: '/assets/maintenance/coffee-grinder-operation.svg',
  burr: '/assets/maintenance/coffee-grinder-operation.svg',
  steam: '/assets/maintenance/steam-wand-cleaning.svg',
  wand: '/assets/maintenance/steam-wand-cleaning.svg',
  milk: '/assets/maintenance/steam-wand-cleaning.svg',
  froth: '/assets/maintenance/steam-wand-cleaning.svg',
  filter: '/assets/maintenance/water-filter-replacement.svg',
  water: '/assets/maintenance/water-filter-replacement.svg',
  replacement: '/assets/maintenance/water-filter-replacement.svg',
  quality: '/assets/maintenance/water-filter-replacement.svg',
  troubleshoot: '/assets/maintenance/troubleshooting-guide.svg',
  problem: '/assets/maintenance/troubleshooting-guide.svg',
  error: '/assets/maintenance/troubleshooting-guide.svg',
  issue: '/assets/maintenance/troubleshooting-guide.svg',
  diagnostic: '/assets/maintenance/troubleshooting-guide.svg',
  repair: '/assets/maintenance/troubleshooting-guide.svg',
  fix: '/assets/maintenance/troubleshooting-guide.svg'
};
