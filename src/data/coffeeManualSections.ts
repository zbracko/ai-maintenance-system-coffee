...
export const coffeeManualSections: CoffeeManualSection[] = [
  ...
  },
  {
    ...
    content: [
      ...
      '',
      '![Daily Cleaning Overview](/src/assets/espresso-machine-cleaning.svg)',
      '',
      ...
      '',
      '![Grinder Operation](/src/assets/coffee-grinder-operation.svg)',
      '',
      ...
      '',
      '![Steam Wand Cleaning](/src/assets/steam-wand-cleaning.svg)',
      '',
  ...
  },
  {
    ...
    content: [
      ...
      '',
      '![Troubleshooting Guide](/src/assets/troubleshooting-guide.svg)',
      '',
  ...
  },
  {
    ...
    content: [
      ...
      '',
      '![Water Filter Replacement](/src/assets/water-filter-replacement.svg)',
      '',
